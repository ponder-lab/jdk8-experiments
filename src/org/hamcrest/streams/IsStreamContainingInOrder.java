...
public class IsStreamContainingInOrder<E> extends TypeSafeDiagnosingMatcher<Stream<? extends E>> {
    
	private final List<Matcher<? super E>> matchers;

    public IsStreamContainingInOrder(List<Matcher<? super E>> matchers) {
        this.matchers = matchers;
    }

    @Override
    protected boolean matchesSafely(Stream<? extends E> stream, Description mismatchDescription) {
        MatchSeries<E> matchSeries = new MatchSeries<E>(matchers, mismatchDescription);
        
        if(stream.allMatch( (E item) -> matchSeries.matches(item))){
    ...
    public void describeTo(Description description) {
        description.appendText("stream containing ").appendList("[", ", ", "]", matchers);
    }
    ...
    public static <E> Matcher<Stream<? extends E>> contains(E... items) {
    ...
    @SuppressWarnings("unchecked")
    @Factory
    public static <E> Matcher<Stream<? extends E>> contains(final Matcher<? super E> itemMatcher) {
    ...
    @SuppressWarnings("unchecked")
    @Factory
    public static <E> Matcher<Stream<? extends E>> contains(Matcher<? super E>... itemMatchers) {
     ...
     */
    @Factory
    public static <E> Matcher<Stream<? extends E>> contains(List<Matcher<? super E>> itemMatchers) {
        return new IsStreamContainingInOrder<E>(itemMatchers);
    }
}
